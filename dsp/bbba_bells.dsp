...
QbL = 1.0/(2.0*shx(0.5*log(2.0))) with { shx(x) = 0.5*(exp(x) - exp(0.0-x)); };

// Analysis bandpass, unity at centre. Detector only - never in the audio path.
bandpass(i) = fi.svf.bp(fcOf(i), QbL) : /(QbL);
...
with {
    ...
    kmat(i,j) = Krow(i) : ba.selector(j,Nbands);
            Krow(0) = 1.03788, -0.19870, -0.00076, -0.00156, -0.00018, -0.00003, -0.00001, -0.00000;
            Krow(1) = -0.19631, 1.07469, -0.19567, -0.00056, -0.00150, -0.00017, -0.00003, -0.00000;
            Krow(2) = -0.00077, -0.19599, 1.07408, -0.19540, -0.00060, -0.00149, -0.00017, -0.00003;
            Krow(3) = -0.00155, -0.00048, -0.19584, 1.07375, -0.19481, -0.00064, -0.00144, -0.00015;
            Krow(4) = -0.00018, -0.00151, -0.00051, -0.19499, 1.07277, -0.19286, -0.00105, -0.00121;
            Krow(5) = -0.00003, -0.00017, -0.00149, -0.00067, -0.19283, 1.06880, -0.18354, -0.00212;
            Krow(6) = -0.00000, -0.00003, -0.00017, -0.00144, -0.00103, -0.18358, 1.05477, -0.14974;
            Krow(7) = -0.00000, -0.00000, -0.00003, -0.00015, -0.00121, -0.00212, -0.14971, 1.02206;
};
...
bellAt(i, g, x) = x : bellv(fcOf(i), QbL, g);
