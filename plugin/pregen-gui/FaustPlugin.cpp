...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /home/ks/.cache/faustpp/276844-md.cpp -lang cpp -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void instanceConstants(int sample_rate) {
		...
		iConst2 = static_cast<int>(std::floor(0.001f * fConst0)) % 2;
		...
		iConst11 = static_cast<int>(std::floor(0.5f * fConst10)) % 2;
		...
		iConst29 = static_cast<int>(std::floor(fConst10)) % 2;
		iConst30 = static_cast<int>(std::floor(0.25f * fConst10)) % 2;
		iConst31 = iConst29 + 2 * iConst11;
		iConst32 = static_cast<int>(std::floor(0.125f * fConst10)) % 2;
		iConst33 = iConst31 + 4 * iConst30;
		iConst34 = static_cast<int>(std::floor(0.0625f * fConst10)) % 2;
		iConst35 = iConst33 + 8 * iConst32;
		iConst36 = static_cast<int>(std::floor(0.03125f * fConst10)) % 2;
		iConst37 = iConst35 + 16 * iConst34;
		iConst38 = static_cast<int>(std::floor(0.015625f * fConst10)) % 2;
		iConst39 = iConst37 + 32 * iConst36;
		iConst40 = static_cast<int>(std::floor(0.0078125f * fConst10)) % 2;
		iConst41 = iConst39 + 64 * iConst38;
		iConst42 = static_cast<int>(std::floor(0.00390625f * fConst10)) % 2;
		...
		fConst98 = std::exp(-(5.714286f / fConst0));
		fConst99 = 0.0001f * (1.0f - fConst98);
		fConst100 = std::exp(-(5.0f / fConst0));
		fConst101 = 0.0001f * (1.0f - fConst100);
		fConst102 = std::exp(-(5e+02f / fConst0));
		fConst103 = std::exp(-(66.666664f / fConst0));
		iConst104 = static_cast<int>(std::floor(0.0005f * fConst0)) % 2;
		iConst105 = static_cast<int>(std::floor(0.00025f * fConst0)) % 2;
		iConst106 = iConst2 + 2 * iConst104;
		iConst107 = static_cast<int>(std::floor(0.000125f * fConst0)) % 2;
		iConst108 = iConst106 + 4 * iConst105;
		iConst109 = static_cast<int>(std::floor(6.25e-05f * fConst0)) % 2;
		iConst110 = iConst108 + 8 * iConst107;
		iConst111 = static_cast<int>(std::floor(3.125e-05f * fConst0)) % 2;
		iConst112 = iConst110 + 16 * iConst109;
		iConst113 = static_cast<int>(std::floor(1.5625e-05f * fConst0)) % 2;
		iConst114 = iConst112 + 32 * iConst111;
		iConst115 = static_cast<int>(std::floor(7.8125e-06f * fConst0)) % 2;
		iConst116 = iConst114 + 64 * iConst113;
		iConst117 = static_cast<int>(std::floor(3.90625e-06f * fConst0)) % 2;
		iConst118 = iConst116 + 128 * iConst115;
		iConst119 = static_cast<int>(std::floor(1.953125e-06f * fConst0)) % 2;
		iConst120 = iConst118 + 256 * iConst117;
		fConst121 = std::exp(-(333.33334f / fConst0));
		fConst122 = std::exp(-(2e+02f / fConst0));
		fConst123 = std::exp(-(5e+01f / fConst0));
		fConst124 = std::exp(-(25.0f / fConst0));
		fConst125 = std::exp(-(16.666666f / fConst0));
		fConst126 = std::exp(-(12.5f / fConst0));
		fConst127 = std::exp(-(33.333332f / fConst0));
		iConst128 = static_cast<int>(fConst9);
		fConst129 = std::exp(-(628.31854f / fConst0));
		fConst130 = 1.0f - fConst129;
		fConst131 = std::exp(-(6.2831855f / fConst0));
		fConst132 = 1.0f - fConst131;
		fConst133 = std::rint(3.0f * fConst0);
		iConst134 = static_cast<int>(std::floor(0.5f * fConst133)) % 2;
		iConst135 = static_cast<int>(std::floor(fConst133)) % 2;
		iConst136 = static_cast<int>(std::floor(0.25f * fConst133)) % 2;
		iConst137 = iConst135 + 2 * iConst134;
		iConst138 = static_cast<int>(std::floor(0.125f * fConst133)) % 2;
		iConst139 = iConst137 + 4 * iConst136;
		iConst140 = static_cast<int>(std::floor(0.0625f * fConst133)) % 2;
		iConst141 = iConst139 + 8 * iConst138;
		iConst142 = static_cast<int>(std::floor(0.03125f * fConst133)) % 2;
		iConst143 = iConst141 + 16 * iConst140;
		iConst144 = static_cast<int>(std::floor(0.015625f * fConst133)) % 2;
		iConst145 = iConst143 + 32 * iConst142;
		iConst146 = static_cast<int>(std::floor(0.0078125f * fConst133)) % 2;
		iConst147 = iConst145 + 64 * iConst144;
		iConst148 = static_cast<int>(std::floor(0.00390625f * fConst133)) % 2;
		iConst149 = iConst147 + 128 * iConst146;
		iConst150 = static_cast<int>(std::floor(0.001953125f * fConst133)) % 2;
		iConst151 = iConst149 + 256 * iConst148;
		iConst152 = static_cast<int>(std::floor(0.0009765625f * fConst133)) % 2;
		iConst153 = iConst151 + 512 * iConst150;
		iConst154 = static_cast<int>(std::floor(0.00048828125f * fConst133)) % 2;
		iConst155 = iConst153 + 1024 * iConst152;
		iConst156 = static_cast<int>(std::floor(0.00024414062f * fConst133)) % 2;
		iConst157 = iConst155 + 2048 * iConst154;
		iConst158 = static_cast<int>(std::floor(0.00012207031f * fConst133)) % 2;
		iConst159 = iConst157 + 4096 * iConst156;
		iConst160 = static_cast<int>(std::floor(6.1035156e-05f * fConst133)) % 2;
		iConst161 = iConst159 + 8192 * iConst158;
		iConst162 = static_cast<int>(std::floor(3.0517578e-05f * fConst133)) % 2;
		iConst163 = iConst161 + 16384 * iConst160;
		iConst164 = static_cast<int>(std::floor(1.5258789e-05f * fConst133)) % 2;
		iConst165 = iConst163 + 32768 * iConst162;
		iConst166 = static_cast<int>(std::floor(7.6293945e-06f * fConst133)) % 2;
		iConst167 = iConst165 + 65536 * iConst164;
		fConst168 = 1.0f / std::max<float>(fConst133, 1.1920929e-07f);
	}
	
	FAUSTPP_VIRTUAL void instanceResetUserInterface() {
		fVslider0 = static_cast<FAUSTFLOAT>(6.0f);
		fVslider1 = static_cast<FAUSTFLOAT>(-23.0f);
		fVslider2 = static_cast<FAUSTFLOAT>(0.9f);
	...
	FAUSTPP_VIRTUAL void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("vad_smoo_t", &fVslider3, FAUSTFLOAT(5e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(1e+01f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = static_cast<float>(fVslider1);
		float fSlow1 = fSlow0 + static_cast<float>(fVslider0);
		float fSlow2 = fSlow1 + -12.0f;
		float fSlow3 = fSlow0 + -12.5f;
		float fSlow4 = static_cast<float>(fVslider2);
		float fSlow5 = 0.001f * static_cast<float>(fVslider3);
		int iSlow6 = std::fabs(fSlow5) < 1.1920929e-07f;
		float fSlow7 = ((iSlow6) ? 0.0f : std::exp(-(fConst7 / ((iSlow6) ? 1.0f : fSlow5))));
		float fSlow8 = static_cast<float>(fVslider4);
		float fSlow9 = fSlow8 * (1.0f - fSlow7);
		float fSlow10 = static_cast<float>(fVslider5);
		float fSlow11 = std::tan(fConst8 * static_cast<float>(fVslider6));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = fTemp0 * static_cast<float>(fTemp0 > fSlow4);
			fVbargraph1 = static_cast<FAUSTFLOAT>(fTemp1);
			float fTemp2 = fTemp1;
			...
			fRec66[0] = fRec70;
			float fRec67 = fRec72;
			float fTemp18 = fSlow10 * fRec67;
			fVbargraph2 = static_cast<FAUSTFLOAT>(fTemp18);
			fRec65[0] = fTemp18;
			fRec80[0] = fSlow14 + fConst46 * fRec80[1];
			float fTemp19 = static_cast<float>(input1[i0]) * fRec80[0];
			...
			fVbargraph3 = static_cast<FAUSTFLOAT>(fRec79[0]);
			float fTemp20 = static_cast<float>(input0[i0]) * fRec80[0];
			...
			fVbargraph4 = static_cast<FAUSTFLOAT>(fRec81[0]);
			float fTemp21 = fTemp20 + fTemp19;
			fVec11[0] = fTemp21;
			fRec78[0] = fSlow16 * (fSlow15 * (fTemp21 - fVec11[1]) - fSlow13 * fRec78[1]);
			...
			fVbargraph36 = static_cast<FAUSTFLOAT>(fRec234[0]);
			...
			int iTemp333 = (fTemp332 >= fRec239[1]) | (static_cast<float>(iRec238[1]) >= fConst9);
			iRec238[0] = ((iTemp333) ? 0 : iRec238[1] + 1);
			fRec239[0] = ((iTemp333) ? fTemp332 : fRec239[1]);
			fRec237[0] = fConst130 * fRec239[0] + fConst129 * fRec237[1];
			float fTemp334 = std::fabs(fRec237[0]);
			fRec236[0] = std::max<float>(fTemp334, fConst131 * fRec236[1] + fConst132 * fTemp334);
			...
			float fTemp336 = fTemp335 * fVec115[(IOTA0 - iConst128) & 2047];
			...
			fVbargraph40 = static_cast<FAUSTFLOAT>(4.3429446f * std::log(std::max<float>(1e-12f, fConst168 * (((iConst166) ? 0.86000985f * fVec157[(IOTA0 - iConst167) & 262143] : 0.0f) + ((iConst164) ? 0.86000985f * fVec156[(IOTA0 - iConst165) & 131071] : 0.0f) + ((iConst162) ? 0.86000985f * fVec155[(IOTA0 - iConst163) & 65535] : 0.0f) + ((iConst160) ? 0.86000985f * fVec154[(IOTA0 - iConst161) & 32767] : 0.0f) + ((iConst158) ? 0.86000985f * fVec153[(IOTA0 - iConst159) & 16383] : 0.0f) + ((iConst156) ? 0.86000985f * fVec152[(IOTA0 - iConst157) & 8191] : 0.0f) + ((iConst154) ? 0.86000985f * fVec151[(IOTA0 - iConst155) & 4095] : 0.0f) + ((iConst152) ? 0.86000985f * fVec150[(IOTA0 - iConst153) & 2047] : 0.0f) + ((iConst150) ? 0.86000985f * fVec149[(IOTA0 - iConst151) & 1023] : 0.0f) + ((iConst148) ? 0.86000985f * fVec148[(IOTA0 - iConst149) & 511] : 0.0f) + ((iConst146) ? 0.86000985f * fVec147[(IOTA0 - iConst147) & 255] : 0.0f) + ((iConst144) ? 0.86000985f * fVec146[(IOTA0 - iConst145) & 127] : 0.0f) + ((iConst142) ? 0.86000985f * fVec145[(IOTA0 - iConst143) & 63] : 0.0f) + ((iConst140) ? 0.86000985f * fVec144[(IOTA0 - iConst141) & 31] : 0.0f) + ((iConst138) ? 0.86000985f * fVec143[iConst139] : 0.0f) + ((iConst136) ? 0.86000985f * fVec142[iConst137] : 0.0f) + ((iConst135) ? 0.86000985f * fTemp356 : 0.0f) + ((iConst134) ? 0.86000985f * fVec141[iConst135] : 0.0f) + ((iConst166) ? 0.86000985f * fVec137[(IOTA0 - iConst167) & 262143] : 0.0f) + ((iConst164) ? 0.86000985f * fVec136[(IOTA0 - iConst165) & 131071] : 0.0f) + ((iConst162) ? 0.86000985f * fVec135[(IOTA0 - iConst163) & 65535] : 0.0f) + ((iConst160) ? 0.86000985f * fVec134[(IOTA0 - iConst161) & 32767] : 0.0f) + ((iConst158) ? 0.86000985f * fVec133[(IOTA0 - iConst159) & 16383] : 0.0f) + ((iConst156) ? 0.86000985f * fVec132[(IOTA0 - iConst157) & 8191] : 0.0f) + ((iConst154) ? 0.86000985f * fVec131[(IOTA0 - iConst155) & 4095] : 0.0f) + ((iConst152) ? 0.86000985f * fVec130[(IOTA0 - iConst153) & 2047] : 0.0f) + ((iConst150) ? 0.86000985f * fVec129[(IOTA0 - iConst151) & 1023] : 0.0f) + ((iConst148) ? 0.86000985f * fVec128[(IOTA0 - iConst149) & 511] : 0.0f) + ((iConst146) ? 0.86000985f * fVec127[(IOTA0 - iConst147) & 255] : 0.0f) + ((iConst144) ? 0.86000985f * fVec126[(IOTA0 - iConst145) & 127] : 0.0f) + ((iConst142) ? 0.86000985f * fVec125[(IOTA0 - iConst143) & 63] : 0.0f) + ((iConst140) ? 0.86000985f * fVec124[(IOTA0 - iConst141) & 31] : 0.0f) + ((iConst138) ? 0.86000985f * fVec123[iConst139] : 0.0f) + ((iConst136) ? 0.86000985f * fVec122[iConst137] : 0.0f) + ((iConst135) ? 0.86000985f * fTemp339 : 0.0f) + ((iConst134) ? 0.86000985f * fVec121[iConst135] : 0.0f)))) + -0.691f);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp338);
			fRec73[1] = fRec73[0];
			fVec0[1] = fVec0[0];
			fRec77[1] = fRec77[0];
			fRec76[1] = fRec76[0];
