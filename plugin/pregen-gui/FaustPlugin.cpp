...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmp6zyw_amn.cpp -lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void instanceConstants(int sample_rate) {
		...
		iConst134 = int(std::floor(0.5f * fConst133)) % 2;
		iConst135 = int(std::floor(fConst133)) % 2;
		iConst136 = int(std::floor(0.25f * fConst133)) % 2;
		iConst137 = iConst135 + 2 * iConst134;
		iConst138 = int(std::floor(0.125f * fConst133)) % 2;
		iConst139 = iConst137 + 4 * iConst136;
		iConst140 = int(std::floor(0.0625f * fConst133)) % 2;
		iConst141 = iConst139 + 8 * iConst138;
		iConst142 = int(std::floor(0.03125f * fConst133)) % 2;
		iConst143 = iConst141 + 16 * iConst140;
		iConst144 = int(std::floor(0.015625f * fConst133)) % 2;
		iConst145 = iConst143 + 32 * iConst142;
		iConst146 = int(std::floor(0.0078125f * fConst133)) % 2;
		iConst147 = iConst145 + 64 * iConst144;
		iConst148 = int(std::floor(0.00390625f * fConst133)) % 2;
		iConst149 = iConst147 + 128 * iConst146;
		iConst150 = int(std::floor(0.001953125f * fConst133)) % 2;
		iConst151 = iConst149 + 256 * iConst148;
		iConst152 = int(std::floor(0.0009765625f * fConst133)) % 2;
		iConst153 = iConst151 + 512 * iConst150;
		iConst154 = int(std::floor(0.00048828125f * fConst133)) % 2;
		iConst155 = iConst153 + 1024 * iConst152;
		iConst156 = int(std::floor(0.00024414062f * fConst133)) % 2;
		iConst157 = iConst155 + 2048 * iConst154;
		iConst158 = int(std::floor(0.00012207031f * fConst133)) % 2;
		iConst159 = iConst157 + 4096 * iConst156;
		iConst160 = int(std::floor(6.1035156e-05f * fConst133)) % 2;
		iConst161 = iConst159 + 8192 * iConst158;
		iConst162 = int(std::floor(3.0517578e-05f * fConst133)) % 2;
		iConst163 = iConst161 + 16384 * iConst160;
		iConst164 = int(std::floor(1.5258789e-05f * fConst133)) % 2;
		iConst165 = iConst163 + 32768 * iConst162;
		iConst166 = int(std::floor(7.6293945e-06f * fConst133)) % 2;
	...
	FAUSTPP_VIRTUAL void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider20, "symbol", "voice_isolation_intensity");
		ui_interface->addVerticalSlider("VIintense", &fVslider20, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow11 = std::tan(fConst8 * float(fVslider6));
		float fSlow12 = 1.0f / fSlow11;
		float fSlow13 = 1.0f - fSlow12;
		float fSlow14 = fConst45 * std::pow(1e+01f, 0.05f * float(fVslider7));
		float fSlow15 = 0.5f / fSlow11;
		float fSlow16 = 1.0f / (fSlow12 + 1.0f);
		float fSlow17 = float(fVslider8);
		float fSlow18 = float(fVslider10);
		float fSlow19 = fSlow8 * fSlow18 * float(fVslider9);
		...
		float fSlow33 = float(fVslider17);
		float fSlow34 = fConst101 * fSlow19;
		float fSlow35 = fSlow0 + -13.5f;
		float fSlow36 = 0.0001f * fSlow18 * float(fVslider18);
		float fSlow37 = fSlow1 + -18.0f;
		float fSlow38 = 7.5e-05f * float(fVslider20) * float(fVslider19) * fSlow18;
