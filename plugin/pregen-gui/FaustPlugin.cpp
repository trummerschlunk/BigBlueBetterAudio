...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/klausscheuermann/Library/Caches/TemporaryItems/faustpp/83890-md.cpp -lang cpp -fpga-mem-th 4 -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void instanceConstants(int sample_rate) {
		...
		iConst34 = static_cast<int>(std::floor(0.00390625f * fConst32)) % 2;
		...
		iConst52 = static_cast<int>(std::floor(fConst32)) % 2;
		iConst53 = static_cast<int>(std::floor(0.5f * fConst32)) % 2;
		iConst54 = iConst52 + 2 * iConst53;
		iConst55 = static_cast<int>(std::floor(0.25f * fConst32)) % 2;
		iConst56 = iConst54 + 4 * iConst55;
		iConst57 = static_cast<int>(std::floor(0.125f * fConst32)) % 2;
		iConst58 = iConst56 + 8 * iConst57;
		iConst59 = static_cast<int>(std::floor(0.0625f * fConst32)) % 2;
		iConst60 = iConst58 + 16 * iConst59;
		iConst61 = static_cast<int>(std::floor(0.03125f * fConst32)) % 2;
		iConst62 = iConst60 + 32 * iConst61;
		iConst63 = static_cast<int>(std::floor(0.015625f * fConst32)) % 2;
		iConst64 = iConst62 + 64 * iConst63;
		iConst65 = static_cast<int>(std::floor(0.0078125f * fConst32)) % 2;
		...
		iConst104 = static_cast<int>(std::floor(0.001f * fConst0)) % 2;
		iConst105 = static_cast<int>(std::floor(0.0005f * fConst0)) % 2;
		iConst106 = static_cast<int>(std::floor(0.00025f * fConst0)) % 2;
		iConst107 = iConst104 + 2 * iConst105;
		iConst108 = static_cast<int>(std::floor(0.000125f * fConst0)) % 2;
		iConst109 = iConst107 + 4 * iConst106;
		iConst110 = static_cast<int>(std::floor(6.25e-05f * fConst0)) % 2;
		iConst111 = iConst109 + 8 * iConst108;
		iConst112 = static_cast<int>(std::floor(3.125e-05f * fConst0)) % 2;
		iConst113 = iConst111 + 16 * iConst110;
		iConst114 = static_cast<int>(std::floor(1.5625e-05f * fConst0)) % 2;
		iConst115 = iConst113 + 32 * iConst112;
		iConst116 = static_cast<int>(std::floor(7.8125e-06f * fConst0)) % 2;
		iConst117 = iConst115 + 64 * iConst114;
		iConst118 = static_cast<int>(std::floor(3.90625e-06f * fConst0)) % 2;
		iConst119 = iConst117 + 128 * iConst116;
		iConst120 = static_cast<int>(std::floor(1.953125e-06f * fConst0)) % 2;
		...
		iConst132 = static_cast<int>(fConst31);
		fConst133 = std::rint(3.0f * fConst0);
		fConst134 = 1.0f / std::max<float>(fConst133, 1.1920929e-07f);
		iConst135 = static_cast<int>(std::floor(7.6293945e-06f * fConst133)) % 2;
		iConst136 = static_cast<int>(std::floor(fConst133)) % 2;
		iConst137 = static_cast<int>(std::floor(0.5f * fConst133)) % 2;
		iConst138 = iConst136 + 2 * iConst137;
		iConst139 = static_cast<int>(std::floor(0.25f * fConst133)) % 2;
		iConst140 = iConst138 + 4 * iConst139;
		iConst141 = static_cast<int>(std::floor(0.125f * fConst133)) % 2;
		iConst142 = iConst140 + 8 * iConst141;
		iConst143 = static_cast<int>(std::floor(0.0625f * fConst133)) % 2;
		iConst144 = iConst142 + 16 * iConst143;
		iConst145 = static_cast<int>(std::floor(0.03125f * fConst133)) % 2;
		iConst146 = iConst144 + 32 * iConst145;
		iConst147 = static_cast<int>(std::floor(0.015625f * fConst133)) % 2;
		iConst148 = iConst146 + 64 * iConst147;
		iConst149 = static_cast<int>(std::floor(0.0078125f * fConst133)) % 2;
		iConst150 = iConst148 + 128 * iConst149;
		iConst151 = static_cast<int>(std::floor(0.00390625f * fConst133)) % 2;
		iConst152 = iConst150 + 256 * iConst151;
		iConst153 = static_cast<int>(std::floor(0.001953125f * fConst133)) % 2;
		iConst154 = iConst152 + 512 * iConst153;
		iConst155 = static_cast<int>(std::floor(0.0009765625f * fConst133)) % 2;
		iConst156 = iConst154 + 1024 * iConst155;
		iConst157 = static_cast<int>(std::floor(0.00048828125f * fConst133)) % 2;
		iConst158 = iConst156 + 2048 * iConst157;
		iConst159 = static_cast<int>(std::floor(0.00024414062f * fConst133)) % 2;
		iConst160 = iConst158 + 4096 * iConst159;
		iConst161 = static_cast<int>(std::floor(0.00012207031f * fConst133)) % 2;
		iConst162 = iConst160 + 8192 * iConst161;
		iConst163 = static_cast<int>(std::floor(6.1035156e-05f * fConst133)) % 2;
		iConst164 = iConst162 + 16384 * iConst163;
		iConst165 = static_cast<int>(std::floor(3.0517578e-05f * fConst133)) % 2;
		iConst166 = iConst164 + 32768 * iConst165;
		iConst167 = static_cast<int>(std::floor(1.5258789e-05f * fConst133)) % 2;
	...
	FAUSTPP_VIRTUAL void instanceResetUserInterface() {
		...
		fVslider11 = static_cast<FAUSTFLOAT>(1e+02f);
	...
	FAUSTPP_VIRTUAL void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider12, "symbol", "voice_isolation_intensity");
		ui_interface->addVerticalSlider("VIintense", &fVslider12, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		...
		ui_interface->declare(&fVslider11, "symbol", "mb_exp_strength");
		ui_interface->declare(&fVslider11, "unit", "%");
		ui_interface->addVerticalSlider("mb_exp_strength", &fVslider11, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fVslider9, "symbol", "mb_strength");
		ui_interface->declare(&fVslider9, "unit", "%");
		ui_interface->addVerticalSlider("mb_strength", &fVslider9, FAUSTFLOAT(5e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
		ui_interface->declare(&fVslider10, "symbol", "mb_exp_thresh");
		ui_interface->declare(&fVslider10, "unit", "dB");
		ui_interface->addVerticalSlider("mb_exp_thresh", &fVslider10, FAUSTFLOAT(6.0f), FAUSTFLOAT(-12.0f), FAUSTFLOAT(12.0f), FAUSTFLOAT(1.0f));
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = std::tan(fConst25 * static_cast<float>(fVslider0));
		float fSlow1 = 1.0f / fSlow0;
		float fSlow2 = 1.0f / (fSlow1 + 1.0f);
		float fSlow3 = 0.5f / fSlow0;
		float fSlow4 = fConst26 * std::pow(1e+01f, 0.05f * static_cast<float>(fVslider1));
		...
		float fSlow15 = fSlow14 * fSlow7 * static_cast<float>(fVslider8);
		float fSlow16 = fConst82 * fSlow15;
		float fSlow17 = fConst91 * fSlow15;
		float fSlow18 = fConst93 * fSlow15;
		float fSlow19 = fConst95 * fSlow15;
		float fSlow20 = fConst96 * fSlow15;
		float fSlow21 = fConst98 * fSlow15;
		float fSlow22 = fConst100 * fSlow15;
		float fSlow23 = fConst102 * fSlow15;
		float fSlow24 = 0.0001f * fSlow14 * static_cast<float>(fVslider9);
		float fSlow25 = fSlow13 + -6.5f;
		float fSlow26 = fSlow13 + -5.5f;
		float fSlow27 = fSlow13 + static_cast<float>(fVslider10);
		float fSlow28 = fSlow27 + -15.0f;
		float fSlow29 = fSlow27 + -9.0f;
		float fSlow30 = 7.5e-05f * static_cast<float>(fVslider11) * fSlow14 * (1.0f - static_cast<float>(fVslider12));
		float fSlow31 = fSlow13 + -7.5f;
		float fSlow32 = fSlow13 + -8.5f;
		float fSlow33 = fSlow13 + -11.5f;
		float fSlow34 = fSlow13 + -10.5f;
		float fSlow35 = fSlow27 + -16.0f;
		float fSlow36 = fSlow27 + -1e+01f;
		float fSlow37 = fSlow13 + -12.5f;
		float fSlow38 = fSlow27 + -17.0f;
		float fSlow39 = fSlow27 + -11.0f;
		float fSlow40 = fSlow13 + -13.5f;
		float fSlow41 = fSlow27 + -18.0f;
		float fSlow42 = fSlow27 + -12.0f;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec56[0] = fSlow4 + fConst27 * fRec56[1];
			float fTemp0 = static_cast<float>(input0[i0]) * fRec56[0];
			...
			fVbargraph0 = static_cast<FAUSTFLOAT>(fRec55[0]);
			float fTemp1 = static_cast<float>(input1[i0]) * fRec56[0];
			...
			fVbargraph1 = static_cast<FAUSTFLOAT>(fRec57[0]);
			...
			fVbargraph5 = static_cast<FAUSTFLOAT>(fTemp50);
			fRec71[0] = fSlow16 * std::min<float>(6.0f, std::max<float>(-12.0f, -1e+01f - fTemp50)) + fConst81 * fRec71[1];
			float fTemp51 = std::pow(1e+01f, 0.05f * fRec71[0]);
			fVbargraph6 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp51)));
			...
			fVbargraph7 = static_cast<FAUSTFLOAT>(-fTemp58);
			fRec89[0] = fSlow17 * std::min<float>(9.0f, std::max<float>(-12.0f, -5.0f - -fTemp58)) + fConst90 * fRec89[1];
			float fTemp59 = std::pow(1e+01f, 0.05f * fRec89[0]);
			fVbargraph8 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp59)));
			...
			fVbargraph9 = static_cast<FAUSTFLOAT>(-fTemp73);
			fRec113[0] = fSlow18 * std::min<float>(12.0f, std::max<float>(-12.0f, -5.0f - -fTemp73)) + fConst92 * fRec113[1];
			float fTemp74 = std::pow(1e+01f, 0.05f * fRec113[0]);
			fVbargraph10 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp74)));
			...
			fVbargraph11 = static_cast<FAUSTFLOAT>(-fTemp81);
			fRec125[0] = fSlow19 * std::min<float>(12.0f, std::max<float>(-12.0f, -8.0f - -fTemp81)) + fConst94 * fRec125[1];
			float fTemp82 = std::pow(1e+01f, 0.05f * fRec125[0]);
			fVbargraph12 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp82)));
			...
			fVbargraph13 = static_cast<FAUSTFLOAT>(-fTemp109);
			fRec169[0] = fSlow20 * std::min<float>(12.0f, std::max<float>(-12.0f, -9.0f - -fTemp109)) + fConst88 * fRec169[1];
			float fTemp110 = std::pow(1e+01f, 0.05f * fRec169[0]);
			fVbargraph14 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp110)));
			...
			fVbargraph15 = static_cast<FAUSTFLOAT>(-fTemp117);
			fRec181[0] = fSlow21 * std::min<float>(12.0f, std::max<float>(-12.0f, -1e+01f - -fTemp117)) + fConst97 * fRec181[1];
			float fTemp118 = std::pow(1e+01f, 0.05f * fRec181[0]);
			fVbargraph16 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp118)));
			...
			fVbargraph17 = static_cast<FAUSTFLOAT>(-fTemp132);
			fRec205[0] = fSlow22 * std::min<float>(9.0f, std::max<float>(-12.0f, -7.0f - -fTemp132)) + fConst99 * fRec205[1];
			float fTemp133 = std::pow(1e+01f, 0.05f * fRec205[0]);
			fVbargraph18 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp133)));
			...
			fRec217[0] = fSlow23 * std::min<float>(6.0f, std::max<float>(-12.0f, -4.0f - -fTemp140)) + fConst101 * fRec217[1];
			...
			int iTemp144 = (fTemp143 > fSlow25) + (fTemp143 > fSlow26);
			...
			float fTemp147 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec224[0]))) + 1.5f)))));
			...
			int iTemp159 = (fTemp158 > fSlow28) + (fTemp158 > fSlow29);
			float fTemp160 = fSlow30 * (1.0f - 0.5f * fTemp5);
			float fTemp161 = std::fabs(fTemp160);
			int iTemp162 = fTemp160 > 0.0f;
			float fTemp163 = static_cast<float>(2 * iTemp162 + -1);
			float fTemp164 = std::max<float>(-12.0f, ((iTemp159 == 0) ? fTemp158 + 12.0f - fSlow27 : ((iTemp159 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp158 + 9.0f - fSlow27)) : 0.0f)) * fTemp161) * fTemp163;
			...
			fVbargraph22 = static_cast<FAUSTFLOAT>(fRec225[0]);
			float fTemp170 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec7)));
			int iTemp171 = (fTemp170 > fSlow25) + (fTemp170 > fSlow26);
			...
			float fTemp174 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec226[0]))) + 1.5f)))));
			...
			int iTemp186 = (fTemp185 > fSlow28) + (fTemp185 > fSlow29);
			float fTemp187 = fTemp163 * std::max<float>(-12.0f, fTemp161 * ((iTemp186 == 0) ? fTemp185 + 12.0f - fSlow27 : ((iTemp186 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp185 + 9.0f - fSlow27)) : 0.0f)));
			...
			fVbargraph24 = static_cast<FAUSTFLOAT>(fRec227[0]);
			float fTemp193 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec8)));
			int iTemp194 = (fTemp193 > fSlow31) + (fTemp193 > fSlow25);
			...
			float fTemp197 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec228[0]))) + 1.5f)))));
			...
			int iTemp209 = (fTemp208 > fSlow28) + (fTemp208 > fSlow29);
			float fTemp210 = fTemp163 * std::max<float>(-12.0f, fTemp161 * ((iTemp209 == 0) ? fTemp208 + 12.0f - fSlow27 : ((iTemp209 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp208 + 9.0f - fSlow27)) : 0.0f)));
			...
			fVbargraph26 = static_cast<FAUSTFLOAT>(fRec229[0]);
			float fTemp216 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec9)));
			int iTemp217 = (fTemp216 > fSlow32) + (fTemp216 > fSlow31);
			...
			float fTemp220 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec230[0]))) + 1.5f)))));
			...
			int iTemp232 = (fTemp231 > fSlow28) + (fTemp231 > fSlow29);
			float fTemp233 = fTemp163 * std::max<float>(-12.0f, fTemp161 * ((iTemp232 == 0) ? fTemp231 + 12.0f - fSlow27 : ((iTemp232 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp231 + 9.0f - fSlow27)) : 0.0f)));
			...
			fVbargraph28 = static_cast<FAUSTFLOAT>(fRec231[0]);
			float fTemp239 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec10)));
			int iTemp240 = (fTemp239 > fSlow33) + (fTemp239 > fSlow34);
			...
			float fTemp243 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec232[0]))) + 1.5f)))));
			...
			int iTemp255 = (fTemp254 > fSlow35) + (fTemp254 > fSlow36);
			float fTemp256 = fTemp163 * std::max<float>(-12.0f, fTemp161 * ((iTemp255 == 0) ? fTemp254 + 13.0f - fSlow27 : ((iTemp255 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp254 + 1e+01f - fSlow27)) : 0.0f)));
			...
			fVbargraph30 = static_cast<FAUSTFLOAT>(fRec233[0]);
			float fTemp262 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec11)));
			int iTemp263 = (fTemp262 > fSlow37) + (fTemp262 > fSlow33);
			...
			float fTemp266 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec234[0]))) + 1.5f)))));
			...
			int iTemp278 = (fTemp277 > fSlow35) + (fTemp277 > fSlow36);
			float fTemp279 = fTemp163 * std::max<float>(-12.0f, fTemp161 * ((iTemp278 == 0) ? fTemp277 + 13.0f - fSlow27 : ((iTemp278 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp277 + 1e+01f - fSlow27)) : 0.0f)));
			...
			fVbargraph32 = static_cast<FAUSTFLOAT>(fRec235[0]);
			float fTemp285 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec12)));
			int iTemp286 = (fTemp285 > fSlow37) + (fTemp285 > fSlow33);
			...
			float fTemp289 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec236[0]))) + 1.5f)))));
			...
			int iTemp301 = (fTemp300 > fSlow38) + (fTemp300 > fSlow39);
			float fTemp302 = fTemp163 * std::max<float>(-12.0f, fTemp161 * ((iTemp301 == 0) ? fTemp300 + 14.0f - fSlow27 : ((iTemp301 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp300 + 11.0f - fSlow27)) : 0.0f)));
			...
			fVbargraph34 = static_cast<FAUSTFLOAT>(fRec237[0]);
			float fTemp308 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec13)));
			int iTemp309 = (fTemp308 > fSlow40) + (fTemp308 > fSlow37);
			...
			float fTemp312 = std::pow(1e+01f, fSlow24 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec238[0]))) + 1.5f)))));
			...
			int iTemp324 = (fTemp323 > fSlow41) + (fTemp323 > fSlow42);
			float fTemp325 = fTemp163 * std::max<float>(-12.0f, fTemp161 * ((iTemp324 == 0) ? fTemp323 + 15.0f - fSlow27 : ((iTemp324 == 1) ? -(0.083333336f * mydsp_faustpower2_f(fTemp323 + 12.0f - fSlow27)) : 0.0f)));
			...
			fVbargraph36 = static_cast<FAUSTFLOAT>(fRec239[0]);
			...
			int iTemp333 = (fTemp332 >= fRec4[1]) | (static_cast<float>(iRec3[1]) >= fConst31);
			...
			fVbargraph37 = static_cast<FAUSTFLOAT>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fTemp335))));
			...
			fVec116[0] = fTemp337;
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp337);
...
protected:
    ...
    * Audio/MIDI Processing */
    ...
    void sampleRateChanged(const double newSampleRate) override
    {
        ...
        dsp->fVslider9 = params[8];
        dsp->fVslider10 = params[9];
