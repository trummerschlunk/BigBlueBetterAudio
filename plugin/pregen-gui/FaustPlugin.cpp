 ...
 public:
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec64[0] = fTemp15;
			fRec77[0] = fSlow7 + fConst44 * fRec77[1];
			float fTemp16 = float(input1[i0]);
			fRec78[0] = std::max<float>(fRec78[1] - fConst1, std::min<float>(12.0f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp16))))));
			fVbargraph1 = FAUSTFLOAT(fRec78[0]);
			...
			float fTemp19 = fTemp18 * fRec77[0];
			fVec11[0] = fTemp19;
			fRec76[0] = fSlow9 * (fSlow8 * (fTemp19 - fVec11[1]) - fSlow6 * fRec76[1]);
			float fTemp20 = fRec76[0] * std::pow(1e+01f, 0.05f * fRec64[0]);
			fVec12[0] = fTemp20;
			float fTemp21 = fRec59[1] + fConst45 * (fTemp20 - fRec60[1]);
			fRec59[0] = fConst47 * fTemp21 - fRec59[1];
			float fTemp22 = fRec60[1] + fConst48 * fTemp21;
			fRec60[0] = 2.0f * fTemp22 - fRec60[1];
			float fRec61 = fTemp20;
			float fRec62 = fConst49 * fTemp21;
			float fRec63 = fTemp22;
			float fTemp23 = fRec63 + 1.4142135f * fRec62;
			float fTemp24 = fRec54[1] + fConst45 * (fRec61 - (fTemp23 + fRec55[1]));
			fRec54[0] = fConst47 * fTemp24 - fRec54[1];
			float fTemp25 = fRec55[1] + fConst48 * fTemp24;
			fRec55[0] = 2.0f * fTemp25 - fRec55[1];
			float fRec56 = fRec61 - fTemp23;
			float fRec57 = fConst49 * fTemp24;
			float fRec58 = fTemp25;
			float fTemp26 = fRec58 + 1.4142135f * fRec57;
			float fTemp27 = fRec50[1] + fConst50 * (fRec56 - (fTemp26 + fRec51[1]));
			fRec50[0] = fConst52 * fTemp27 - fRec50[1];
			float fTemp28 = fRec51[1] + fConst53 * fTemp27;
			fRec51[0] = 2.0f * fTemp28 - fRec51[1];
			float fRec52 = fRec56 - fTemp26;
			float fRec53 = fConst54 * fTemp27;
			float fTemp29 = 2.828427f * fRec53;
			float fTemp30 = fRec46[1] + fConst55 * (fRec52 - (fTemp29 + fRec47[1]));
			fRec46[0] = fConst57 * fTemp30 - fRec46[1];
			float fTemp31 = fRec47[1] + fConst58 * fTemp30;
			fRec47[0] = 2.0f * fTemp31 - fRec47[1];
			float fRec48 = fRec52 - fTemp29;
			float fRec49 = fConst59 * fTemp30;
			float fTemp32 = 2.828427f * fRec49;
			float fTemp33 = fRec42[1] + fConst60 * (fRec48 - (fTemp32 + fRec43[1]));
			fRec42[0] = fConst62 * fTemp33 - fRec42[1];
			float fTemp34 = fRec43[1] + fConst63 * fTemp33;
			fRec43[0] = 2.0f * fTemp34 - fRec43[1];
			float fRec44 = fRec48 - fTemp32;
			float fRec45 = fConst64 * fTemp33;
			float fTemp35 = 2.828427f * fRec45;
			float fTemp36 = fRec37[1] + fConst65 * (fRec44 - (fTemp35 + fRec38[1]));
			fRec37[0] = fConst67 * fTemp36 - fRec37[1];
			float fTemp37 = fRec38[1] + fConst68 * fTemp36;
			fRec38[0] = 2.0f * fTemp37 - fRec38[1];
			float fRec39 = fRec44 - fTemp35;
			float fRec40 = fConst69 * fTemp36;
			float fRec41 = fTemp37;
			float fTemp38 = fRec41 + 1.4142135f * fRec40;
			float fTemp39 = fRec32[1] + fConst65 * (fRec39 - (fTemp38 + fRec33[1]));
			fRec32[0] = fConst67 * fTemp39 - fRec32[1];
			float fTemp40 = fRec33[1] + fConst68 * fTemp39;
			fRec33[0] = 2.0f * fTemp40 - fRec33[1];
			float fRec34 = fRec39 - fTemp38;
			float fRec35 = fConst69 * fTemp39;
			float fRec36 = fTemp40;
			float fTemp41 = fRec36 + 1.4142135f * fRec35;
			float fTemp42 = fRec28[1] + fConst70 * (fRec34 - (fTemp41 + fRec29[1]));
			fRec28[0] = fConst72 * fTemp42 - fRec28[1];
			float fTemp43 = fRec29[1] + fConst73 * fTemp42;
			fRec29[0] = 2.0f * fTemp43 - fRec29[1];
			float fRec30 = fRec34 - fTemp41;
			float fRec31 = fConst74 * fTemp42;
			float fTemp44 = 2.828427f * fRec31;
			float fTemp45 = fRec23[1] + fConst75 * (fRec30 - (fTemp44 + fRec24[1]));
			fRec23[0] = fConst77 * fTemp45 - fRec23[1];
			float fTemp46 = fRec24[1] + fConst78 * fTemp45;
			fRec24[0] = 2.0f * fTemp46 - fRec24[1];
			float fRec25 = fRec30 - fTemp44;
			float fRec26 = fConst79 * fTemp45;
			float fRec27 = fTemp46;
			float fTemp47 = fRec27 + 1.4142135f * fRec26;
			float fTemp48 = fRec18[1] + fConst75 * (fRec25 - (fTemp47 + fRec19[1]));
			fRec18[0] = fConst77 * fTemp48 - fRec18[1];
			float fTemp49 = fRec19[1] + fConst78 * fTemp48;
			fRec19[0] = 2.0f * fTemp49 - fRec19[1];
			float fRec20 = fRec25 - fTemp47;
			float fRec21 = fConst79 * fTemp48;
			float fRec22 = fTemp49;
			float fTemp50 = fRec20 - (fRec22 + 1.4142135f * fRec21);
			fVec13[0] = fTemp50;
			fVec14[0] = fConst82 * fVec13[1] - fConst17 * fRec16[1];
			fRec17[0] = fConst20 * (fVec14[1] - fConst14 * fRec17[1] + fConst81 * fVec13[1] + fConst80 * fTemp50);
			fRec16[0] = fRec17[0];
			...
			fRec14[0] = fRec15[0];
			float fTemp51 = std::fabs(0.92736715f * fRec14[0]);
			fRec13[0] = std::max<float>(fTemp51, fConst83 * fRec13[1] + fConst84 * fTemp51);
			fRec12[0] = fConst85 * fRec13[0] + fConst3 * fRec12[1];
			fVec16[0] = fConst17 * fRec84[1] - fConst15 * fVec12[1];
			fRec85[0] = fConst20 * (fConst19 * fVec12[1] - (fVec16[1] + fConst14 * fRec85[1]) + fConst13 * fTemp20);
			fRec84[0] = fRec85[0];
			...
			fRec82[0] = fRec83[0];
			float fTemp52 = std::fabs(0.92736715f * fRec82[0]);
			fRec81[0] = std::max<float>(fTemp52, fConst83 * fRec81[1] + fConst84 * fTemp52);
			fRec80[0] = fConst85 * fRec81[0] + fConst3 * fRec80[1];
			float fTemp53 = std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec80[0])));
			float fTemp54 = 2e+01f * (fTemp53 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec12[0]))));
			fVbargraph3 = FAUSTFLOAT(-fTemp54);
			fRec11[0] = fConst86 * (fSlow10 - -fTemp54) + fConst2 * fRec11[1];
			float fTemp55 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec11[0])));
			fVbargraph4 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp55)));
			float fTemp56 = fTemp50 * fTemp55;
			float fTemp57 = fRec93[1] + fConst75 * (fRec27 - fRec94[1]);
			fRec93[0] = fConst77 * fTemp57 - fRec93[1];
			float fTemp58 = fRec94[1] + fConst78 * fTemp57;
			fRec94[0] = 2.0f * fTemp58 - fRec94[1];
			fRec95[0] = fTemp58;
			...
			fRec89[0] = fRec90[0];
			float fTemp59 = std::fabs(0.92736715f * fRec89[0]);
			fRec88[0] = std::max<float>(fTemp59, fConst83 * fRec88[1] + fConst84 * fTemp59);
			fRec87[0] = fConst85 * fRec88[0] + fConst3 * fRec87[1];
			float fTemp60 = 2e+01f * (fTemp53 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec87[0]))));
			fVbargraph5 = FAUSTFLOAT(-fTemp60);
			fRec86[0] = fConst88 * (fSlow13 - -fTemp60) + fConst87 * fRec86[1];
			float fTemp61 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec86[0])));
			fVbargraph6 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp61)));
			float fTemp62 = fRec95[0] * fTemp61;
			float fTemp63 = fRec117[1] + fConst65 * (fRec41 - fRec118[1]);
			fRec117[0] = fConst67 * fTemp63 - fRec117[1];
			float fTemp64 = fRec118[1] + fConst68 * fTemp63;
			fRec118[0] = 2.0f * fTemp64 - fRec118[1];
			float fRec119 = fTemp64;
			float fTemp65 = fRec113[1] + fConst75 * (fRec119 - fRec114[1]);
			fRec113[0] = fConst77 * fTemp65 - fRec113[1];
			float fTemp66 = fRec114[1] + fConst78 * fTemp65;
			fRec114[0] = 2.0f * fTemp66 - fRec114[1];
			float fRec115 = fRec119;
			float fRec116 = fConst79 * fTemp65;
			float fTemp67 = 2.828427f * fRec116;
			float fTemp68 = fRec108[1] + fConst70 * (fRec115 - (fTemp67 + fRec109[1]));
			fRec108[0] = fConst72 * fTemp68 - fRec108[1];
			float fTemp69 = fRec109[1] + fConst73 * fTemp68;
			fRec109[0] = 2.0f * fTemp69 - fRec109[1];
			float fRec110 = fRec115 - fTemp67;
			float fRec111 = fConst74 * fTemp68;
			float fRec112 = fTemp69;
			float fTemp70 = fRec112 + 1.4142135f * fRec111;
			float fTemp71 = fRec103[1] + fConst70 * (fRec110 - (fTemp70 + fRec104[1]));
			fRec103[0] = fConst72 * fTemp71 - fRec103[1];
			float fTemp72 = fRec104[1] + fConst73 * fTemp71;
			fRec104[0] = 2.0f * fTemp72 - fRec104[1];
			float fRec105 = fRec110 - fTemp70;
			float fRec106 = fConst74 * fTemp71;
			float fRec107 = fTemp72;
			float fTemp73 = fRec105 - (fRec107 + 1.4142135f * fRec106);
			fVec20[0] = fTemp73;
			fVec21[0] = fConst82 * fVec20[1] - fConst17 * fRec101[1];
			fRec102[0] = fConst20 * (fVec21[1] - fConst14 * fRec102[1] + fConst81 * fVec20[1] + fConst80 * fTemp73);
			fRec101[0] = fRec102[0];
			...
			fRec99[0] = fRec100[0];
			float fTemp74 = std::fabs(0.92736715f * fRec99[0]);
			fRec98[0] = std::max<float>(fTemp74, fConst83 * fRec98[1] + fConst84 * fTemp74);
			fRec97[0] = fConst85 * fRec98[0] + fConst3 * fRec97[1];
			float fTemp75 = 2e+01f * (fTemp53 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec97[0]))));
			fVbargraph7 = FAUSTFLOAT(-fTemp75);
			fRec96[0] = fConst90 * (fSlow14 - -fTemp75) + fConst89 * fRec96[1];
			float fTemp76 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec96[0])));
			fVbargraph8 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp76)));
			float fTemp77 = fTemp73 * fTemp76;
			float fTemp78 = fRec127[1] + fConst70 * (fRec112 - fRec128[1]);
			fRec127[0] = fConst72 * fTemp78 - fRec127[1];
			float fTemp79 = fRec128[1] + fConst73 * fTemp78;
			fRec128[0] = 2.0f * fTemp79 - fRec128[1];
			fRec129[0] = fTemp79;
			...
			fRec123[0] = fRec124[0];
			float fTemp80 = std::fabs(0.92736715f * fRec123[0]);
			fRec122[0] = std::max<float>(fTemp80, fConst83 * fRec122[1] + fConst84 * fTemp80);
			fRec121[0] = fConst85 * fRec122[0] + fConst3 * fRec121[1];
			float fTemp81 = 2e+01f * (fTemp53 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec121[0]))));
			fVbargraph9 = FAUSTFLOAT(-fTemp81);
			fRec120[0] = fConst84 * (fSlow15 - -fTemp81) + fConst83 * fRec120[1];
			float fTemp82 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec120[0])));
			fVbargraph10 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp82)));
			float fTemp83 = fRec129[0] * fTemp82;
			float fTemp84 = fRec173[1] + fConst45 * (fRec63 - fRec174[1]);
			fRec173[0] = fConst47 * fTemp84 - fRec173[1];
			float fTemp85 = fRec174[1] + fConst48 * fTemp84;
			fRec174[0] = 2.0f * fTemp85 - fRec174[1];
			float fRec175 = fTemp85;
			float fTemp86 = fRec169[1] + fConst65 * (fRec175 - fRec170[1]);
			fRec169[0] = fConst67 * fTemp86 - fRec169[1];
			float fTemp87 = fRec170[1] + fConst68 * fTemp86;
			fRec170[0] = 2.0f * fTemp87 - fRec170[1];
			float fRec171 = fRec175;
			float fRec172 = fConst69 * fTemp86;
			float fTemp88 = 2.828427f * fRec172;
			float fTemp89 = fRec165[1] + fConst70 * (fRec171 - (fTemp88 + fRec166[1]));
			fRec165[0] = fConst72 * fTemp89 - fRec165[1];
			float fTemp90 = fRec166[1] + fConst73 * fTemp89;
			fRec166[0] = 2.0f * fTemp90 - fRec166[1];
			float fRec167 = fRec171 - fTemp88;
			float fRec168 = fConst74 * fTemp89;
			float fTemp91 = 2.828427f * fRec168;
			float fTemp92 = fRec161[1] + fConst75 * (fRec167 - (fTemp91 + fRec162[1]));
			fRec161[0] = fConst77 * fTemp92 - fRec161[1];
			float fTemp93 = fRec162[1] + fConst78 * fTemp92;
			fRec162[0] = 2.0f * fTemp93 - fRec162[1];
			float fRec163 = fRec167 - fTemp91;
			float fRec164 = fConst79 * fTemp92;
			float fTemp94 = 2.828427f * fRec164;
			float fTemp95 = fRec156[1] + fConst50 * (fRec163 - (fTemp94 + fRec157[1]));
			fRec156[0] = fConst52 * fTemp95 - fRec156[1];
			float fTemp96 = fRec157[1] + fConst53 * fTemp95;
			fRec157[0] = 2.0f * fTemp96 - fRec157[1];
			float fRec158 = fRec163 - fTemp94;
			float fRec159 = fConst54 * fTemp95;
			float fRec160 = fTemp96;
			float fTemp97 = fRec160 + 1.4142135f * fRec159;
			float fTemp98 = fRec151[1] + fConst50 * (fRec158 - (fTemp97 + fRec152[1]));
			fRec151[0] = fConst52 * fTemp98 - fRec151[1];
			float fTemp99 = fRec152[1] + fConst53 * fTemp98;
			fRec152[0] = 2.0f * fTemp99 - fRec152[1];
			float fRec153 = fRec158 - fTemp97;
			float fRec154 = fConst54 * fTemp98;
			float fRec155 = fTemp99;
			float fTemp100 = fRec155 + 1.4142135f * fRec154;
			float fTemp101 = fRec147[1] + fConst55 * (fRec153 - (fTemp100 + fRec148[1]));
			fRec147[0] = fConst57 * fTemp101 - fRec147[1];
			float fTemp102 = fRec148[1] + fConst58 * fTemp101;
			fRec148[0] = 2.0f * fTemp102 - fRec148[1];
			float fRec149 = fRec153 - fTemp100;
			float fRec150 = fConst59 * fTemp101;
			float fTemp103 = 2.828427f * fRec150;
			float fTemp104 = fRec142[1] + fConst60 * (fRec149 - (fTemp103 + fRec143[1]));
			fRec142[0] = fConst62 * fTemp104 - fRec142[1];
			float fTemp105 = fRec143[1] + fConst63 * fTemp104;
			fRec143[0] = 2.0f * fTemp105 - fRec143[1];
			float fRec144 = fRec149 - fTemp103;
			float fRec145 = fConst64 * fTemp104;
			float fRec146 = fTemp105;
			float fTemp106 = fRec146 + 1.4142135f * fRec145;
			float fTemp107 = fRec137[1] + fConst60 * (fRec144 - (fTemp106 + fRec138[1]));
			fRec137[0] = fConst62 * fTemp107 - fRec137[1];
			float fTemp108 = fRec138[1] + fConst63 * fTemp107;
			fRec138[0] = 2.0f * fTemp108 - fRec138[1];
			float fRec139 = fRec144 - fTemp106;
			float fRec140 = fConst64 * fTemp107;
			float fRec141 = fTemp108;
			float fTemp109 = fRec139 - (fRec141 + 1.4142135f * fRec140);
			fVec25[0] = fTemp109;
			fVec26[0] = fConst82 * fVec25[1] - fConst17 * fRec135[1];
			fRec136[0] = fConst20 * (fVec26[1] - fConst14 * fRec136[1] + fConst81 * fVec25[1] + fConst80 * fTemp109);
			fRec135[0] = fRec136[0];
			...
			fRec133[0] = fRec134[0];
			float fTemp110 = std::fabs(0.92736715f * fRec133[0]);
			fRec132[0] = std::max<float>(fTemp110, fConst83 * fRec132[1] + fConst84 * fTemp110);
			fRec131[0] = fConst85 * fRec132[0] + fConst3 * fRec131[1];
			float fTemp111 = 2e+01f * (fTemp53 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec131[0]))));
			fVbargraph11 = FAUSTFLOAT(-fTemp111);
			fRec130[0] = fConst92 * (fSlow16 - -fTemp111) + fConst91 * fRec130[1];
			float fTemp112 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec130[0])));
			fVbargraph12 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp112)));
			float fTemp113 = fTemp109 * fTemp112;
			float fTemp114 = fRec183[1] + fConst60 * (fRec146 - fRec184[1]);
			fRec183[0] = fConst62 * fTemp114 - fRec183[1];
			float fTemp115 = fRec184[1] + fConst63 * fTemp114;
			fRec184[0] = 2.0f * fTemp115 - fRec184[1];
			fRec185[0] = fTemp115;
			...
			fRec179[0] = fRec180[0];
			float fTemp116 = std::fabs(0.92736715f * fRec179[0]);
			fRec178[0] = std::max<float>(fTemp116, fConst83 * fRec178[1] + fConst84 * fTemp116);
			fRec177[0] = fConst85 * fRec178[0] + fConst3 * fRec177[1];
			float fTemp117 = 2e+01f * (fTemp53 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec177[0]))));
			fVbargraph13 = FAUSTFLOAT(-fTemp117);
			fRec176[0] = fConst94 * (fSlow17 - -fTemp117) + fConst93 * fRec176[1];
			float fTemp118 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec176[0])));
			fVbargraph14 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp118)));
			float fTemp119 = fRec185[0] * fTemp118;
			float fTemp120 = fRec207[1] + fConst50 * (fRec160 - fRec208[1]);
			fRec207[0] = fConst52 * fTemp120 - fRec207[1];
			float fTemp121 = fRec208[1] + fConst53 * fTemp120;
			fRec208[0] = 2.0f * fTemp121 - fRec208[1];
			float fRec209 = fTemp121;
			float fTemp122 = fRec203[1] + fConst60 * (fRec209 - fRec204[1]);
			fRec203[0] = fConst62 * fTemp122 - fRec203[1];
			float fTemp123 = fRec204[1] + fConst63 * fTemp122;
			fRec204[0] = 2.0f * fTemp123 - fRec204[1];
			float fRec205 = fRec209;
			float fRec206 = fConst64 * fTemp122;
			float fTemp124 = 2.828427f * fRec206;
			float fTemp125 = fRec198[1] + fConst55 * (fRec205 - (fTemp124 + fRec199[1]));
			fRec198[0] = fConst57 * fTemp125 - fRec198[1];
			float fTemp126 = fRec199[1] + fConst58 * fTemp125;
			fRec199[0] = 2.0f * fTemp126 - fRec199[1];
			float fRec200 = fRec205 - fTemp124;
			float fRec201 = fConst59 * fTemp125;
			float fRec202 = fTemp126;
			float fTemp127 = fRec202 + 1.4142135f * fRec201;
			float fTemp128 = fRec193[1] + fConst55 * (fRec200 - (fTemp127 + fRec194[1]));
			fRec193[0] = fConst57 * fTemp128 - fRec193[1];
			float fTemp129 = fRec194[1] + fConst58 * fTemp128;
			fRec194[0] = 2.0f * fTemp129 - fRec194[1];
			float fRec195 = fRec200 - fTemp127;
			float fRec196 = fConst59 * fTemp128;
			float fRec197 = fTemp129;
			float fTemp130 = fRec195 - (fRec197 + 1.4142135f * fRec196);
			fVec30[0] = fTemp130;
			fVec31[0] = fConst82 * fVec30[1] - fConst17 * fRec191[1];
			fRec192[0] = fConst20 * (fVec31[1] - fConst14 * fRec192[1] + fConst81 * fVec30[1] + fConst80 * fTemp130);
			fRec191[0] = fRec192[0];
			...
			fRec189[0] = fRec190[0];
			float fTemp131 = std::fabs(0.92736715f * fRec189[0]);
			fRec188[0] = std::max<float>(fTemp131, fConst83 * fRec188[1] + fConst84 * fTemp131);
			fRec187[0] = fConst85 * fRec188[0] + fConst3 * fRec187[1];
			float fTemp132 = 2e+01f * (fTemp53 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec187[0]))));
			fVbargraph15 = FAUSTFLOAT(-fTemp132);
			fRec186[0] = fConst96 * (fSlow18 - -fTemp132) + fConst95 * fRec186[1];
			float fTemp133 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec186[0])));
			fVbargraph16 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp133)));
			float fTemp134 = fTemp130 * fTemp133;
			float fTemp135 = fRec217[1] + fConst55 * (fRec202 - fRec218[1]);
			fRec217[0] = fConst57 * fTemp135 - fRec217[1];
			float fTemp136 = fRec218[1] + fConst58 * fTemp135;
			fRec218[0] = 2.0f * fTemp136 - fRec218[1];
			fRec219[0] = fTemp136;
			...
			fRec213[0] = fRec214[0];
			float fTemp137 = std::fabs(0.92736715f * fRec213[0]);
			fRec212[0] = std::max<float>(fTemp137, fConst83 * fRec212[1] + fConst84 * fTemp137);
			fRec211[0] = fConst85 * fRec212[0] + fConst3 * fRec211[1];
			float fTemp138 = 2e+01f * (std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec211[0]))) - fTemp53);
			fVbargraph17 = FAUSTFLOAT(fTemp138);
			fRec210[0] = fConst98 * (fSlow19 - fTemp138) + fConst97 * fRec210[1];
			float fTemp139 = std::pow(1e+01f, fSlow12 * std::min<float>(12.0f, std::max<float>(-12.0f, fRec210[0])));
			fVbargraph18 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp139)));
			float fTemp140 = fRec219[0] * fTemp139;
			fRec2[0] = fTemp140 + fTemp134 + fTemp119 + fTemp113 + fTemp83 + fTemp77 + fTemp62 + fTemp56;
			float fRec3 = fTemp140;
			float fRec4 = fTemp134;
			float fRec5 = fTemp119;
			float fRec6 = fTemp113;
			float fRec7 = fTemp83;
			float fRec8 = fTemp77;
			float fRec9 = fTemp62;
			float fRec10 = fTemp56;
			float fTemp141 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec10)));
			int iTemp142 = (fTemp141 > fSlow20) + (fTemp141 > fSlow1);
			float fTemp143 = std::max<float>(0.0f, ((iTemp142 == 0) ? 0.0f : ((iTemp142 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp141 + 13.5f - fSlow0) : fTemp141 + 13.0f - fSlow0)));
			float fTemp144 = ((-(0.75f * fTemp143) > fRec1[1]) ? fConst100 : fConst99);
			fRec1[0] = fRec1[1] * fTemp144 - 0.75f * fTemp143 * (1.0f - fTemp144);
			float fTemp145 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec1[0]))) + 1.5f)))));
			fVbargraph19 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp145)));
			float fTemp146 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec9)));
			int iTemp147 = (fTemp146 > fSlow1) + (fTemp146 > fSlow22);
			float fTemp148 = std::max<float>(0.0f, ((iTemp147 == 0) ? 0.0f : ((iTemp147 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp146 + 12.5f - fSlow0) : fTemp146 + 12.0f - fSlow0)));
			float fTemp149 = ((-(0.75f * fTemp148) > fRec220[1]) ? fConst100 : fConst101);
			fRec220[0] = fRec220[1] * fTemp149 - 0.75f * fTemp148 * (1.0f - fTemp149);
			float fTemp150 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec220[0]))) + 1.5f)))));
			fVbargraph20 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp150)));
			float fTemp151 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec8)));
			int iTemp152 = (fTemp151 > fSlow1) + (fTemp151 > fSlow22);
			float fTemp153 = std::max<float>(0.0f, ((iTemp152 == 0) ? 0.0f : ((iTemp152 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp151 + 12.5f - fSlow0) : fTemp151 + 12.0f - fSlow0)));
			float fTemp154 = ((-(0.75f * fTemp153) > fRec221[1]) ? fConst100 : fConst102);
			fRec221[0] = fRec221[1] * fTemp154 - 0.75f * fTemp153 * (1.0f - fTemp154);
			float fTemp155 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec221[0]))) + 1.5f)))));
			fVbargraph21 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp155)));
			float fTemp156 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec7)));
			int iTemp157 = (fTemp156 > fSlow22) + (fTemp156 > fSlow23);
			float fTemp158 = std::max<float>(0.0f, ((iTemp157 == 0) ? 0.0f : ((iTemp157 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp156 + 11.5f - fSlow0) : fTemp156 + 11.0f - fSlow0)));
			float fTemp159 = ((-(0.75f * fTemp158) > fRec222[1]) ? fConst103 : fConst3);
			fRec222[0] = fRec222[1] * fTemp159 - 0.75f * fTemp158 * (1.0f - fTemp159);
			float fTemp160 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec222[0]))) + 1.5f)))));
			fVbargraph22 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp160)));
			float fTemp161 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec6)));
			int iTemp162 = (fTemp161 > fSlow25) + (fTemp161 > fSlow24);
			float fTemp163 = std::max<float>(0.0f, ((iTemp162 == 0) ? 0.0f : ((iTemp162 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp161 + 8.5f - fSlow0) : fTemp161 + 8.0f - fSlow0)));
			float fTemp164 = ((-(0.75f * fTemp163) > fRec223[1]) ? fConst104 : fConst100);
			fRec223[0] = fRec223[1] * fTemp164 - 0.75f * fTemp163 * (1.0f - fTemp164);
			float fTemp165 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec223[0]))) + 1.5f)))));
			fVbargraph23 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp165)));
			float fTemp166 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec5)));
			int iTemp167 = (fTemp166 > fSlow24) + (fTemp166 > fSlow26);
			float fTemp168 = std::max<float>(0.0f, ((iTemp167 == 0) ? 0.0f : ((iTemp167 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp166 + 7.5f - fSlow0) : fTemp166 + 7.0f - fSlow0)));
			float fTemp169 = ((-(0.75f * fTemp168) > fRec224[1]) ? fConst105 : fConst103);
			fRec224[0] = fRec224[1] * fTemp169 - 0.75f * fTemp168 * (1.0f - fTemp169);
			float fTemp170 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec224[0]))) + 1.5f)))));
			fVbargraph24 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp170)));
			float fTemp171 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec4)));
			int iTemp172 = (fTemp171 > fSlow26) + (fTemp171 > fSlow27);
			float fTemp173 = std::max<float>(0.0f, ((iTemp172 == 0) ? 0.0f : ((iTemp172 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp171 + 6.5f - fSlow0) : fTemp171 + 6.0f - fSlow0)));
			float fTemp174 = ((-(0.75f * fTemp173) > fRec225[1]) ? fConst106 : fConst2);
			fRec225[0] = fRec225[1] * fTemp174 - 0.75f * fTemp173 * (1.0f - fTemp174);
			float fTemp175 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec225[0]))) + 1.5f)))));
			fVbargraph25 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp175)));
			float fTemp176 = 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fRec3)));
			int iTemp177 = (fTemp176 > fSlow26) + (fTemp176 > fSlow27);
			float fTemp178 = std::max<float>(0.0f, ((iTemp177 == 0) ? 0.0f : ((iTemp177 == 1) ? 0.5f * mydsp_faustpower2_f(fTemp176 + 6.5f - fSlow0) : fTemp176 + 6.0f - fSlow0)));
			float fTemp179 = ((-(0.75f * fTemp178) > fRec226[1]) ? fConst83 : fConst107);
			fRec226[0] = fRec226[1] * fTemp179 - 0.75f * fTemp178 * (1.0f - fTemp179);
			float fTemp180 = std::pow(1e+01f, fSlow21 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec226[0]))) + 1.5f)))));
			fVbargraph26 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fTemp180)));
			float fTemp181 = fRec3 * fTemp180 + fRec4 * fTemp175 + fRec5 * fTemp170 + fRec6 * fTemp165 + fRec7 * fTemp160 + fRec8 * fTemp155 + fRec9 * fTemp150 + fRec10 * fTemp145;
			fVec35[IOTA0 & 2047] = fTemp181;
			float fTemp182 = std::fabs(fTemp181);
			int iTemp183 = (fTemp182 >= fRec230[1]) | (float(iRec229[1]) >= fConst7);
			iRec229[0] = ((iTemp183) ? 0 : iRec229[1] + 1);
			fRec230[0] = ((iTemp183) ? fTemp182 : fRec230[1]);
			fRec228[0] = fConst110 * fRec230[0] + fConst109 * fRec228[1];
			float fTemp184 = std::fabs(fRec228[0]);
			fRec227[0] = std::max<float>(fTemp184, fConst111 * fRec227[1] + fConst112 * fTemp184);
			float fTemp185 = std::min<float>(1.0f, 0.8912509f / std::max<float>(fRec227[0], 1.1920929e-07f));
			fVbargraph27 = FAUSTFLOAT(2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::fabs(fTemp185))));
			fRec231[0] = fSlow28 + fConst44 * fRec231[1];
			float fTemp186 = 0.5f * fTemp18 * fRec231[0] + (1.0f - fRec231[0]) * fTemp185 * fVec35[(IOTA0 - iConst108) & 2047];
			fRec0[0] = std::max<float>(fRec0[1] - fConst1, std::min<float>(12.0f, 2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::max<float>(0.00031622776f, std::fabs(fTemp186))))));
			fVbargraph28 = FAUSTFLOAT(fRec0[0]);
			float fTemp187 = fTemp186;
			fVec36[0] = fTemp187;
			output0[i0] = FAUSTFLOAT(fTemp187);
			fVbargraph29 = FAUSTFLOAT(fRec0[0]);
			float fTemp188 = fTemp186;
			fVec37[0] = fTemp188;
			fVec38[0] = fConst17 * fRec234[1] - fConst15 * fVec37[1];
			fRec235[0] = fConst20 * (fConst19 * fVec37[1] - (fVec38[1] + fConst14 * fRec235[1]) + fConst13 * fTemp188);
			fRec234[0] = fRec235[0];
			...
			fRec232[0] = fRec233[0];
			float fTemp189 = mydsp_faustpower2_f(fRec232[0]);
			fVec40[0] = fTemp189;
			float fTemp190 = fTemp189 + fVec40[1];
			fVec41[0] = fTemp190;
			float fTemp191 = fTemp190 + fVec41[2];
			fVec42[0] = fTemp191;
			float fTemp192 = fTemp191 + fVec42[4];
			fVec43[0] = fTemp192;
			float fTemp193 = fTemp192 + fVec43[8];
			fVec44[IOTA0 & 31] = fTemp193;
			float fTemp194 = fTemp193 + fVec44[(IOTA0 - 16) & 31];
			fVec45[IOTA0 & 63] = fTemp194;
			float fTemp195 = fTemp194 + fVec45[(IOTA0 - 32) & 63];
			fVec46[IOTA0 & 127] = fTemp195;
			float fTemp196 = fTemp195 + fVec46[(IOTA0 - 64) & 127];
			fVec47[IOTA0 & 255] = fTemp196;
			float fTemp197 = fTemp196 + fVec47[(IOTA0 - 128) & 255];
			fVec48[IOTA0 & 511] = fTemp197;
			float fTemp198 = fTemp197 + fVec48[(IOTA0 - 256) & 511];
			fVec49[IOTA0 & 1023] = fTemp198;
			float fTemp199 = fTemp198 + fVec49[(IOTA0 - 512) & 1023];
			fVec50[IOTA0 & 2047] = fTemp199;
			float fTemp200 = fTemp199 + fVec50[(IOTA0 - 1024) & 2047];
			fVec51[IOTA0 & 4095] = fTemp200;
			float fTemp201 = fTemp200 + fVec51[(IOTA0 - 2048) & 4095];
			fVec52[IOTA0 & 8191] = fTemp201;
			float fTemp202 = fTemp201 + fVec52[(IOTA0 - 4096) & 8191];
			fVec53[IOTA0 & 16383] = fTemp202;
			float fTemp203 = fTemp202 + fVec53[(IOTA0 - 8192) & 16383];
			fVec54[IOTA0 & 32767] = fTemp203;
			float fTemp204 = fTemp203 + fVec54[(IOTA0 - 16384) & 32767];
			fVec55[IOTA0 & 65535] = fTemp204;
			float fTemp205 = fTemp204 + fVec55[(IOTA0 - 32768) & 65535];
			fVec56[IOTA0 & 131071] = fTemp205;
			fVec57[IOTA0 & 262143] = fTemp205 + fVec56[(IOTA0 - 65536) & 131071];
			fVec58[0] = fConst17 * fRec238[1] - fConst15 * fVec36[1];
			fRec239[0] = fConst20 * (fConst19 * fVec36[1] - (fVec58[1] + fConst14 * fRec239[1]) + fConst13 * fTemp187);
			fRec238[0] = fRec239[0];
