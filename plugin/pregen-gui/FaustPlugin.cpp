...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmptge8uzhw.cpp -lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow18 = fSlow8 * fSlow17 * float(fVslider8);
		...
		float fSlow28 = 0.0001f * fSlow17 * float(fVslider10);
		float fSlow29 = fSlow1 + -18.0f;
		float fSlow30 = 7.5e-05f * float(fVslider12) * fSlow17 * (1.0f - float(fVslider11));
