...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/klausscheuermann/Library/Caches/TemporaryItems/faustpp/41480-md.cpp -lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow24 = 0.0001f * fSlow14 * float(fVslider9);
		float fSlow25 = fSlow13 + -6.5f;
		float fSlow26 = fSlow13 + -5.5f;
		float fSlow27 = fSlow13 + float(fVslider10);
		float fSlow28 = fSlow27 + -15.0f;
		float fSlow29 = fSlow27 + -9.0f;
		float fSlow30 = 7.5e-05f * float(fVslider11) * fSlow14 * (1.0f - float(fVslider12));
