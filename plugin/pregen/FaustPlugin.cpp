...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /tmp/tmpja0bmj8f.cpp -lang cpp -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	FAUSTPP_VIRTUAL void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow10 = fConst44 * std::pow(1e+01f, 0.05f * float(fVslider5));
		float fSlow11 = 1.0f / std::tan(fConst7 * float(fVslider6));
		float fSlow12 = 1.0f - fSlow11;
		float fSlow13 = 1.0f / (fSlow11 + 1.0f);
		float fSlow14 = float(fVslider7);
		float fSlow15 = float(fVslider9);
		float fSlow16 = fSlow7 * fSlow15 * float(fVslider8);
		float fSlow17 = fConst87 * fSlow16;
		float fSlow18 = float(fVslider10);
		float fSlow19 = fConst89 * fSlow16;
		float fSlow20 = float(fVslider11);
		float fSlow21 = fConst91 * fSlow16;
		float fSlow22 = float(fVslider12);
		float fSlow23 = fConst92 * fSlow16;
		float fSlow24 = float(fVslider13);
		float fSlow25 = fConst94 * fSlow16;
		float fSlow26 = float(fVslider14);
		float fSlow27 = fConst96 * fSlow16;
		float fSlow28 = float(fVslider15);
		float fSlow29 = fConst98 * fSlow16;
		float fSlow30 = float(fVslider16);
		float fSlow31 = fConst100 * fSlow16;
		float fSlow32 = fSlow0 + -13.5f;
		float fSlow33 = 0.0001f * fSlow15 * float(fVslider17);
		float fSlow34 = fSlow0 + -12.0f;
		float fSlow35 = 0.75f * float(fVslider18) * fSlow15;
		...
		float fSlow48 = fConst44 * float(fCheckbox0);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec72[0] = fSlow8 + fSlow6 * fRec72[1];
			...
			fRec65[0] = fRec69;
			float fRec66 = fRec71;
			fRec64[0] = fSlow9 * fRec66;
			fRec78[0] = fSlow10 + fConst45 * fRec78[1];
			float fTemp17 = float(input0[i0]);
			float fTemp18 = fTemp17 * fRec78[0];
			fVec11[0] = fTemp18;
			fRec77[0] = -(fSlow13 * (fSlow12 * fRec77[1] - fSlow11 * (fTemp18 - fVec11[1])));
			...
			fRec11[0] = fSlow17 * std::min<float>(6.0f, std::max<float>(-12.0f, fSlow14 + 2e+01f * (fTemp52 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec12[0])))))) + fConst2 * fRec11[1];
			float fTemp53 = fTemp49 * std::pow(1e+01f, 0.05f * fRec11[0]);
			...
			fRec85[0] = fSlow19 * std::min<float>(9.0f, std::max<float>(-12.0f, fSlow18 + 2e+01f * (fTemp52 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec86[0])))))) + fConst88 * fRec85[1];
			float fTemp57 = fRec94[0] * std::pow(1e+01f, 0.05f * fRec85[0]);
			...
			fRec95[0] = fSlow21 * std::min<float>(12.0f, std::max<float>(-12.0f, fSlow20 + 2e+01f * (fTemp52 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec96[0])))))) + fConst90 * fRec95[1];
			float fTemp70 = fTemp68 * std::pow(1e+01f, 0.05f * fRec95[0]);
			...
			fRec119[0] = fSlow23 * std::min<float>(12.0f, std::max<float>(-12.0f, fSlow22 + 2e+01f * (fTemp52 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec120[0])))))) + fConst84 * fRec119[1];
			float fTemp74 = fRec128[0] * std::pow(1e+01f, 0.05f * fRec119[0]);
			...
			fRec129[0] = fSlow25 * std::min<float>(12.0f, std::max<float>(-12.0f, fSlow24 + 2e+01f * (fTemp52 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec130[0])))))) + fConst93 * fRec129[1];
			float fTemp102 = fTemp100 * std::pow(1e+01f, 0.05f * fRec129[0]);
			...
			fRec175[0] = fSlow27 * std::min<float>(12.0f, std::max<float>(-12.0f, fSlow26 + 2e+01f * (fTemp52 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec176[0])))))) + fConst95 * fRec175[1];
			float fTemp106 = fRec184[0] * std::pow(1e+01f, 0.05f * fRec175[0]);
			...
			fRec185[0] = fSlow29 * std::min<float>(9.0f, std::max<float>(-12.0f, fSlow28 + 2e+01f * (fTemp52 - std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec186[0])))))) + fConst97 * fRec185[1];
			float fTemp119 = fTemp117 * std::pow(1e+01f, 0.05f * fRec185[0]);
			...
			fRec209[0] = fSlow31 * std::min<float>(6.0f, std::max<float>(-12.0f, fSlow30 - 2e+01f * (std::log10(std::max<float>(1.1754944e-38f, std::max<float>(3.1622778e-05f, fRec210[0]))) - fTemp52))) + fConst99 * fRec209[1];
			float fTemp123 = fRec218[0] * std::pow(1e+01f, 0.05f * fRec209[0]);
			...
			float fTemp127 = ((-(0.75f * fTemp126) > fRec1[1]) ? fConst102 : fConst101);
			fRec1[0] = fRec1[1] * fTemp127 - 0.75f * fTemp126 * (1.0f - fTemp127);
			float fTemp128 = fRec10 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec1[0]))) + 1.5f)))));
			...
			float fTemp153 = ((-(0.75f * fTemp152) > fRec220[1]) ? fConst102 : fConst120);
			fRec220[0] = fRec220[1] * fTemp153 - 0.75f * fTemp152 * (1.0f - fTemp153);
			float fTemp154 = fRec9 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec220[0]))) + 1.5f)))));
			...
			float fTemp175 = ((-(0.75f * fTemp174) > fRec222[1]) ? fConst102 : fConst121);
			fRec222[0] = fRec222[1] * fTemp175 - 0.75f * fTemp174 * (1.0f - fTemp175);
			float fTemp176 = fRec8 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec222[0]))) + 1.5f)))));
			...
			float fTemp197 = ((-(0.75f * fTemp196) > fRec224[1]) ? fConst122 : fConst3);
			fRec224[0] = fRec224[1] * fTemp197 - 0.75f * fTemp196 * (1.0f - fTemp197);
			float fTemp198 = fRec7 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec224[0]))) + 1.5f)))));
			...
			float fTemp219 = ((-(0.75f * fTemp218) > fRec226[1]) ? fConst123 : fConst102);
			fRec226[0] = fRec226[1] * fTemp219 - 0.75f * fTemp218 * (1.0f - fTemp219);
			float fTemp220 = fRec6 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec226[0]))) + 1.5f)))));
			...
			float fTemp241 = ((-(0.75f * fTemp240) > fRec228[1]) ? fConst124 : fConst122);
			fRec228[0] = fRec228[1] * fTemp241 - 0.75f * fTemp240 * (1.0f - fTemp241);
			float fTemp242 = fRec5 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec228[0]))) + 1.5f)))));
			...
			float fTemp263 = ((-(0.75f * fTemp262) > fRec230[1]) ? fConst125 : fConst2);
			fRec230[0] = fRec230[1] * fTemp263 - 0.75f * fTemp262 * (1.0f - fTemp263);
			float fTemp264 = fRec4 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec230[0]))) + 1.5f)))));
			...
			float fTemp285 = ((-(0.75f * fTemp284) > fRec232[1]) ? fConst84 : fConst126);
			fRec232[0] = fRec232[1] * fTemp285 - 0.75f * fTemp284 * (1.0f - fTemp285);
			float fTemp286 = fRec3 * std::pow(1e+01f, fSlow33 * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * (2e+01f * std::log10(std::max<float>(1.1754944e-38f, std::pow(1e+01f, 0.05f * fRec232[0]))) + 1.5f)))));
			...
			fRec234[0] = fConst129 * fRec236[0] + fConst128 * fRec234[1];
			float fTemp307 = std::fabs(fRec234[0]);
			fRec233[0] = std::max<float>(fTemp307, fConst130 * fRec233[1] + fConst131 * fTemp307);
			...
			fRec237[0] = fSlow48 + fConst45 * fRec237[1];
			output0[i0] = FAUSTFLOAT(fTemp17 * fRec237[0] + (1.0f - fRec237[0]) * fTemp308 * fVec115[(IOTA0 - iConst127) & 2047]);
			fRec72[1] = fRec72[0];
			fVec0[1] = fVec0[0];
			fRec76[1] = fRec76[0];
			fRec75[1] = fRec75[0];
