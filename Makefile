...
CFLAGS += -DMAC_OS_X_VERSION_MAX_ALLOWED=MAC_OS_VERSION_13_3
CFLAGS += -UMAC_OS_X_VERSION_MIN_REQUIRED
CFLAGS += -DMAC_OS_X_VERSION_MIN_REQUIRED=MAC_OS_VERSION_13_3
CFLAGS += -mmacosx-version-min=13.3
CXXFLAGS += -UMAC_OS_X_VERSION_MAX_ALLOWED
CXXFLAGS += -DMAC_OS_X_VERSION_MAX_ALLOWED=MAC_OS_VERSION_13_3
CXXFLAGS += -UMAC_OS_X_VERSION_MIN_REQUIRED
CXXFLAGS += -DMAC_OS_X_VERSION_MIN_REQUIRED=MAC_OS_VERSION_13_3
CXXFLAGS += -mmacosx-version-min=13.3
LDFLAGS += -mmacosx-version-min=13.3
endif
